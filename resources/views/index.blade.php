...
<body>
    ...
    <nav class="navbar" data-stisla-navbar>
        ...
        <div class="navbar__menu" data-state="closed">
            <ul class="navbar__nav">
                ...
                <li>
                    <a class="navbar__button" href="#produk">Produk Kami</a>
                </li>
                <li>
    ...
    <div class="page container mt-10 px-4 sm:px-6 lg:px-8 items-center">
                ...
                <div class="card__body space-y-4 lg:flex-row">
                    ...
                    <div>
                        ...
                        <div class="flex flex-row justify-between items-center lg:flex-col lg:space-y-6">
                            ...
                            <p class="text-(--color-primary-foreground) bg-(--color-primary-emphasis) text-2xl rounded-xl p-1">
                                7878787573
                            </p>
                        </div>
                    </div>
        ...
        {{-- produk --}}
        <section class="page__section" id="produk">
            <div class="page__section-header justify-center">
                <div class="page__section-title">
                    Cek Juga Produk Kami
                </div>
            </div>
            @foreach ($produk as $p)
            <div class="card">
                <div
                    class="carousel carousel--no-aspect"
                    data-stisla-carousel
                    tabindex="0"
                    role="region"
                    aria-label="foto {{$p->nama_produk}}"
                >
        ...
        <!-- form -->
        <section class="page__section max-w-7xl w-full mx-auto px-4 sm:px-0" id="daftar">
            <div class="page__section-header justify-center">
                <div class="page__section-title">
            ...
            <form 
                class="flex flex-col w-full gap-3 pb-64"
                onsubmit="event.preventDefault();"
                id="form"
            >
                <div class="gap-5 lg:flex lg:flex-row">
                    <div class="field">
                        {{-- pilih paket umroh --}}
                ...
                <div class="field">
                    ...
                    <div class="field__description text-xs">
    ...
    <footer class="bg-primary text-white mt-16">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <a 
                    class="link"
                    href="https://www.instagram.com/refandyakbar?igsh=djMyY2ZnbjVwOG9j"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    <svg
                ...
                <a 
                    href="https://www.facebook.com/share/1DN4SX5Xhv/"
                    class="link"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                ...
                >
                    ...
                    Jl. Bunga Asoka No.49C Medan 20133       
                </a>
            </div>  
